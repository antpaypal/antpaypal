...
#ifndef ANTPAYPALGUI_H
#define ANTPAYPALGUI_H
...
/**
  Antpaypal GUI main class. This class represents the main window of the Antpaypal UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AntpaypalGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit AntpaypalGUI(QWidget *parent = 0);
    ~AntpaypalGUI();
