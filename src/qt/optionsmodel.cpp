...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::APP).toInt();
    ...
    fAutoRedeemAntpaypal = settings.value("fAutoRedeemAntpaypal", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemAntpaypal:
            return fAutoRedeemAntpaypal;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemAntpaypal: return "AutoRedeemAntpaypal";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::APP).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemAntpaypal: {
            fAutoRedeemAntpaypal = value.toBool();
            settings.setValue("fAutoRedeemAntpaypal", fAutoRedeemAntpaypal);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemAntpaypal() { return fAutoRedeemAntpaypal; }
