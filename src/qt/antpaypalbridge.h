#ifndef ANTPAYPALBRIDGE_H
#define ANTPAYPALBRIDGE_H
...
class AntpaypalBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit AntpaypalBridge(AntpaypalGUI *window, QObject *parent = 0);
    ~AntpaypalBridge();
