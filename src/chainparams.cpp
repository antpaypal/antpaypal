...
public:
    CBaseChainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("42.51.153.80",  "seed.antpaypal.com"));
        vSeeds.push_back(CDNSSeedData("seed2.antpaypal.com", "seed2.antpaypal.com"));
        vSeeds.push_back(CDNSSeedData("seed3.antpaypal.com", "seed3.antpaypal.com"));
        vSeeds.push_back(CDNSSeedData("seed4.antpaypal.com", "seed4.antpaypal.com"));
        vSeeds.push_back(CDNSSeedData("antpaypalproject.io",  "seed.antpaypalproject.io"));
        vSeeds.push_back(CDNSSeedData("antpaypalchain.info",  "seed.antpaypalchain.info"));
    }
...
public:
    CMainParams() {
        ...
        base58Prefixes[SCRIPT_ADDRESS]      = list_of(83).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[SECRET_KEY]          = list_of(191).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[STEALTH_ADDRESS]     = list_of(0).convert_to_container<std::vector<unsigned char> >();
