...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.antpaypal
    BOOST_LIB_SUFFIX=-mt
...
contains(ANTPAYPAL_NEED_QT_PLUGINS, 1) {
    DEFINES += ANTPAYPAL_NEED_QT_PLUGINS
...
HEADERS += \
    ...
    src/qt/antpaypalgui.h \
    src/qt/antpaypalbridge.h \
...
SOURCES += \
    ...
    src/qt/antpaypalgui.cpp \
    src/qt/antpaypal.cpp \
    src/qt/antpaypalbridge.cpp
...
# also add new translations to antpaypal.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/antpaypal*.ts)
...
macx:ICON = src/qt/res/icons/antpaypal.icns
macx:TARGET = "Antpaypal"
